# Day 2
___
That is Christmas, the second day of our challenge. Today I spent a lot of time coding
and learning. Firstly, I finished the workshop on FreeCodeCamp and started the next topic, 
**Handling Errors**, which is much more difficult than I expected. Then, I practiced LeetCode
problems and solved 10 problems — most of them on my own, and the rest with the help of 
AI to fix my logic or YouTube videos for guidance, while I implemented the solutions myself. 

Furthermore, I learned how to use `**kwargs` as a parameter in my functions and watched a tutorial about 
debugging using `pdb` in the terminal. I didn’t really like it, since we already have debugging modes in IDEs.

This day was so tough, and I spent at least **6 hours** on various tasks.  
In the **[LeetCode problems](#letcode-problems)** section, you can find descriptions of each 
function that I wrote myself.
___
## FreeCodeCamp

### Workshop: medical-data-validator
In **fifth task** of this module I learned that isinstance can take several types for validation

![img.png](img.png)

### Debug an ISBN Validator
This is the first lab where it is necessary to understand the logic of already written code.
I have always been bad at debugging code written by other people. For example, when someone at the university
asked me why their code didn’t work, I didn’t even try to figure it out or help. So I realized
that this lab would be taken very seriously, and I decided to postpone it until later.

### Assert
There is a method `assert` in Python that can be used to raise errors with a specific condition.
It is simply a shorter way to show an error compared to the `raise` statement.
___
